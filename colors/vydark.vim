...
hi Normal        guifg=#dddddd  guibg=grey20
hi Title         guifg=white
hi Cursor        guibg=#ffffff
hi LineNr        guifg=yellowgreen  guibg=grey20
...
hi Statement     guifg=#99bbcc  gui=none
...
hi Keyword       guifg=#eeeebb  gui=none
...
hi phpIdentifier          guifg=#eeeebb gui=none
hi link phpIntVar         phpIdentifier
hi link phpVarSelector    phpIdentifier
hi phpNumber              guifg=#ffbbbb
hi phpFunctions           guifg=#ffffff
hi phpInclude             guifg=#ffbbbb
hi phpSpecialFunction     guifg=#ffffff gui=bold
hi javaScriptRegexpString guifg=#88ff99
hi vimFuncName            guifg=#ffffff
